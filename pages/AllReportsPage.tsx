...
import { Consultancy, Page } from '../types';
...
const AllReportsPage: React.FC<AllReportsPageProps> = ({ onSelectConsultancy, onNavigate }) => {
  const [searchTerm, setSearchTerm] = useState('');
  
  const allReports = MOCK_CONSULTANCIES.filter(
    (c) => c.submissionStatus === 'approved' &&
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="mt-6 text-xl text-gray-600">
            A complete list of all community-reported consultancies, sorted by date.
          </p>
