...
const ForCompaniesForm: React.FC = () => {
    ...
    return (
        <section>
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6 bg-white p-8 rounded-lg border border-gray-200">
                <div>
                ...
                <button type="submit" className="w-full bg-red-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-red-700 transition-colors duration-300">
                    Submit
                </button>
            </form>
        </section>
